...
.. member:: dpiDbTokenCallback dbTokenCallback
    ...
    :member:`dpiDbTokenInfo.dbToken` and :member:`dpiDbTokenInfo.dbTokenPrivateKey`
    in the dbTokenInfo argument. The authentication token
    can be generated by invoking the Oracle Cloud Infrastructure (OCI) Command
    Line Interface (CLI).
    ...
    The callback accepts the following arguments:
        ...
        **context** -- the value of the
        :member:`dpiPoolCreateParams.dbTokenCallbackContext` member.

        **dbTokenInfo** -- a pointer to the structure :ref:`dpiDbTokenInfo<dpiDbTokenInfo>`.

.. member:: void* dpiPoolCreateParams.dbTokenCallbackContext

    Specifies the value that will be used as the first argument to the callback
    specified in the :member:`dpiDbTokenCallback.dbTokenCallback` member. The
