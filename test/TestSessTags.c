...
//-----------------------------------------------------------------------------
// dpiTest_3100_verifyTags()
//   Verify that session tagging works as expected (no error).
//-----------------------------------------------------------------------------
int dpiTest_3100_verifyTags(dpiTestCase *testCase, dpiTestParams *params)
{
...
//-----------------------------------------------------------------------------
// dpiTest_3101_verifySessionWithInvalidTag()
//   Specify tag name with invalid format and verify it throws an error
// (ORA-24488).
//-----------------------------------------------------------------------------
int dpiTest_3101_verifySessionWithInvalidTag(dpiTestCase *testCase,
...
//-----------------------------------------------------------------------------
// dpiTest_3102_verifySessionCallbackPLSQL()
...
// database.
//-----------------------------------------------------------------------------
int dpiTest_3102_verifySessionCallbackPLSQL(dpiTestCase *testCase,
        dpiTestParams *params)
{
...
int main(int argc, char **argv)
{
    ...
    dpiTestSuite_addCase(dpiTest_3100_verifyTags,
            "verify session tagging works as expected");
    dpiTestSuite_addCase(dpiTest_3101_verifySessionWithInvalidTag,
            "specify invalid tag and verify");
    dpiTestSuite_addCase(dpiTest_3102_verifySessionCallbackPLSQL,
