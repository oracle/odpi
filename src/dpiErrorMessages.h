...
static const char* const dpiErrorMessages[DPI_ERR_MAX - DPI_ERR_NO_ERR] = {
    ...
    "DPI-1011: connection has not been acquired with this session pool", // DPI_ERR_CONN_NOT_IN_POOL
    ...
    "DPI-1014: unhandled conversion between Oracle type %d and native type %d", // DPI_ERR_UNHANDLED_CONVERSION
    ...
    "DPI-1020: version %d.%d is not supported by library version %d.%d", // DPI_ERR_VERSION_NOT_SUPPORTED
    ...
    "DPI-1027: scroll operation would leave result set", // DPI_ERR_SCROLL_OUT_OF_RS
    ...
    "DPI-1030: unable to get or set TLS error structure", // DPI_ERR_TLS_ERROR
    ...
    "DPI-1035: the size of the transaction ID is %u and cannot exceed %u", // DPI_ERR_TRANS_ID_TOO_LARGE
    "DPI-1036: the size of the branch ID is %u and cannot exceed %u", // DPI_ERR_BRANCH_ID_TOO_LARGE
    "DPI-1037: column at array pos %u fetched with error %u", // DPI_ERR_COLUMN_FETCH
    "DPI-1038: Oracle client %u.%u cannot be used because ODPI-C was compiled with Oracle client %u.%u", // DPI_ERR_OCI_VERSION_NOT_SUPPORTED
    "DPI-1039: statement is closed", // DPI_ERR_STMT_CLOSED
    "DPI-1040: LOB is closed", // DPI_ERR_LOB_CLOSED
    ...
    "DPI-1045: a string that is converted to a number can only be up to 135 characters long", // DPI_ERR_NUMBER_STRING_TOO_LONG
    "DPI-1046: a NULL pointer is not permitted for parameter %s", // DPI_ERR_NULL_POINTER_PARAMETER
};
